...
sed -i 's/keystore.storepass = .*/keystore.storepass = storepass1337/' /tmp/mirthstuff/mirthconnect_3_12_0/conf/mirth.properties
sed -i 's/keystore.keypass = .*/keystore.keypass = keypass1337/' /tmp/mirthstuff/mirthconnect_3_12_0/conf/mirth.properties
